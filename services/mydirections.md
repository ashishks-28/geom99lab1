...
```
(https://maps.googleapis.com/maps/api/directions/json?origin=Lucknow&avoid=tolls|highways|&destination=Ayodhya&waypoints=Bundelkhand+University+Jhansi|Varanasi&key=AIzaSyCM-WWHYHIKY-do4kquMy9Z4wQaQx51AuE)
```
